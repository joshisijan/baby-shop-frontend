    ...
    return (
        <div>
            <div className="bg-secondary-varient grid justify-items-center">
                <div className="px-6 py-10 w-full max-w-6xl bg-secondary-varient flex flex-col items-center">
            ...
            <div className="bg-primary-varient p-6 pt-8 pb-14 grid justify-items-center">
